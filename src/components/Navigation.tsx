...
import { Play, Gamepad2, Briefcase, Trophy, User, LogIn, Menu, Wallet, Flame, Users, LayoutDashboard, ShieldCheck, Coins, Bell, LogOut, ShoppingCart, Upload, Megaphone, Star, Crown } from 'lucide-react';
