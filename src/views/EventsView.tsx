      ...
      {settings?.eventMode ? (
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
               ...
               <div className="bg-black/40 backdrop-blur-sm border border-purple-500/50 rounded-2xl p-4 text-center min-w-[200px]">
                  <div className="text-purple-300 text-sm font-bold mb-1 flex items-center justify-center gap-2">
                     <Timer size={16} /> لفترة محدودة جداً
                  </div>
                  <div className="text-2xl font-black text-white font-mono">سارع بالمشاركة!</div>
               </div>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-5 hover:border-amber-500/30 transition-colors">
               ...
               <button onClick={() => setActiveTab('videos')} className="w-full bg-neutral-800 hover:bg-neutral-700 text-white font-bold py-2 rounded-xl transition-colors">ابدأ الآن</button>
            </div>
         ...
         <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-12 text-center flex flex-col items-center justify-center">
             <Calendar className="text-neutral-600 mb-4" size={48} />
             <h3 className="text-xl font-bold text-white mb-2">لا توجد فعاليات نشطة حالياً</h3>
             <p className="text-neutral-400 max-w-md mx-auto">ترقبوا الفعاليات القادمة! نقوم بتنظيم مهرجانات مضاعفة النقاط ومسابقات أخرى بانتظام.</p>
         </div>
      )}
